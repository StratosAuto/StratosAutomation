...
public class Stratos_Admin_3rdPartyProvider {
	...
	public void user_clicks_on_Add_New_Provider_button() throws Exception {
		...
		testBase.clickonElement(Stratos_Admin_3rdPartyProviders_PageObjects.addNewProviderButton, "Add New Provider");
	}
...
//	  Invalid Postal Code
	...
	public void user_clicks_on_Cancel_button() throws Exception {
		Thread.sleep(5000);
		testBase.clickonElement(Stratos_Admin_3rdPartyProviders_PageObjects.cancelButton, "Cancel");
	}
...
// Other Contact Number invalid field length
		...
		testBase.waitForElement(Stratos_Admin_3rdPartyProviders_PageObjects.otherContactNumber, 20);
		testBase.typeinTextBox(Stratos_Admin_3rdPartyProviders_PageObjects.otherContactNumber, lengthOtherContactNumber,
...
// Comments invalid field length
	...
	public void user_Validates_the_error_messages_of_Invalid_field_length_data_of_all_the_feilds() throws Exception {
		...
		if (!(testBase.isElementVisible(Stratos_Admin_3rdPartyProviders_PageObjects.lengthProviderName,
		...
		if (!(testBase.isElementVisible(Stratos_Admin_3rdPartyProviders_PageObjects.lengthStreet,
		...
		if (!(testBase.isElementVisible(Stratos_Admin_3rdPartyProviders_PageObjects.lengthStreet2,
				"Maximum 100 characters Allowed."))) {
			ExceptionHandling.HandleAssertion("Maximum 100 characters Allowed element is not visible");
		} else
			Logs.info("Maximum 100 characters Allowed element is visible");
	...
	public void user_clicks_on_Save_and_Continue_button_to_validate_mandatory_fields() throws Exception {
		...
		if (testBase.isElementVisible(Stratos_Admin_3rdPartyProviders_PageObjects.nullValidate,
...
// Inactive Providers	
	...
	public void user_enters_invalid_Provider_Ref_as_on_Active_Providers(String string) throws Exception {
	...
	@Then("User enters invalid Provider Ref as {string} on Inactive Providers")
	public void user_enters_invalid_Provider_Ref_as_on_Inactive_Providers(String string) throws Exception {
	...
	public void user_validates_the_updates_of_Active_Providers() throws Exception {
		...
		testBase.typeinTextBox(Stratos_Admin_3rdPartyProviders_PageObjects.filter, filterProviderName, "Provider Name");
		testBase.clickonElement(Stratos_Admin_3rdPartyProviders_PageObjects.manageProviderButton, "Manage Provider");
		String updatedVatNumber1 = testBase.driver.findElement(By.xpath("//input[@formcontrolname='mobileNumber']"))
				.getText();
...
//		testBase.clickonElement(Stratos_3rdPartyProviders_PageObjects.selectFile, "Select File");
	...
	@Given("User validates the error message as {string} of null Bulk Upload")
