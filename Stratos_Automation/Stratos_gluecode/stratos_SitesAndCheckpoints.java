...
public class stratos_SitesAndCheckpoints {
	...
	public void verify_that_user_able_to_enter_invalid_data_in_Add_new_site_page() throws Exception {
	    ...
	    String s=testBase.getElementText(Stratos_SitesAndCheckpoints_PageObjects.SiteNameError, "site name error");
	    System.out.println(s);
	    
	    testBase.waitForElement(Stratos_SitesAndCheckpoints_PageObjects.completeAdress, 20);
	   String completeAdress=testBase.randomAplhabet(251);
	    ...
	    testBase.waitForElement(Stratos_SitesAndCheckpoints_PageObjects.contactsFirstName, 20);
	    String ContactsFirstName=testBase.randomAplhabet(26);
	    
	    testBase.typeinTextBox(Stratos_SitesAndCheckpoints_PageObjects.contactsFirstName, ContactsFirstName, "contact first name");
	    Thread.sleep(2000);
	    testBase.clickonElement(Stratos_SitesAndCheckpoints_PageObjects.siteCancelButton, "site name");
	    Thread.sleep(2000);
...
//	    testBase.typeinTextBox(Stratos_SitesAndCheckpoints_PageObjects.filterButton, siteName, "Filter");
	...
	@When("User clicks on Select File button and upload file")
