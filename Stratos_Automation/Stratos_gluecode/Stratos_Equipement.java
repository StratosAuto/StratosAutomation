...
//		testBase.clickonElement(Stratos_Admin_Equipment_PageObject.selectEquipmentType, "Pistol");
	...
	public void admin_User_Select_the_Expiry_Date_from_Drop_Down() throws Exception {
		testBase.waitForElement(Stratos_Admin_Equipment_PageObject.licenseExpirydateButton, 20);
		testBase.clickonElement(Stratos_Admin_Equipment_PageObject.selectlicenseExpirydate, "select the date");
		Thread.sleep(2000);
	}
...
//		testBase.waitForElement(Stratos_Admin_Equipment_PageObject.selectSiteName, 20);
	...
	@Then("User validates the success message as {string} in bulk upload")
	public void user_validates_the_success_message_as_in_bulk_upload(String string) {
	   
	}

	@Then("User validates the error message as {string} of invalid Bulk Upload in equipment page")
	public void user_validates_the_error_message_as_of_invalid_Bulk_Upload_in_equipment_page(String string) {
	   
	}

	@Then("User clicks on cancel button in bulk upload equipment page")
	public void user_clicks_on_cancel_button_in_bulk_upload_equipment_page() {
	   
	}

	@Then("User validates the error message as {string} of null Bulk Upload in equipment page")
	public void user_validates_the_error_message_as_of_null_Bulk_Upload_in_equipment_page(String string) {
