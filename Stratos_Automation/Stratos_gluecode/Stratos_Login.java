...
public class Stratos_Login {
	...
	public void enter_Email_Address() throws Exception {
		...
		testBase.clickonElement(Stratos_Login_PageObjects.email, "Email Address");
		testBase.typeinTextBox(Stratos_Login_PageObjects.email, valid_Username, "Email Address");
	}

	@Given("Enter Password")
	public void enter_Password() throws Exception {
		testBase.waitForElement(Stratos_Login_PageObjects.password, 20);
		testBase.clickonElement(Stratos_Login_PageObjects.password, "Password");
		testBase.typeinTextBox(Stratos_Login_PageObjects.password, String.valueOf(valid_Password), "password");
	}
