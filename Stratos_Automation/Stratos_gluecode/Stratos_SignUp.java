...
public class Stratos_SignUp {
	...
	public void user_Verify_the_Sign_Up_functionality_with_invalid_data() throws Exception {
		Thread.sleep(3000);
    Excel_Utility.setExcelFile(excelFileLocation, sheetName);
		String firstName= testBase.randomAplhabet(26);
		...
		testBase.typeinTextBox(Stratos_SignUp_PageObjects.emailAddress, emailAdress, "enter first name");
		Thread.sleep(2000);
...
//		testBase.clickonElement(Stratos_SignUp_PageObjects.confirmPassord, "Confirmpassword");
		testBase.typeinTextBox(Stratos_SignUp_PageObjects.confirmPassord, String.valueOf(Confirmpassword), "Confirmpassword");
...
//			testBase.clickonElement(Stratos_SignUp_PageObjects.roleDropdown, "rolo dropdown");
