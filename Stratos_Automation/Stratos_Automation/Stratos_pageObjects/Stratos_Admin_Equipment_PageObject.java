...
//			By.xpath("//mat-select[@formcontrolname='autoAllocate']");
	...
	public static final By selectClientName=By.xpath("//span[text()='Roses']");
	public static final By selectSiteName=By.xpath("//span[text()='Elisa estate gate 23']");
	...
	public static final By equipmentNameValidate=By.xpath("//td[text()='KUKKI-123']");
	public static final By equipmentNameValidateequipmentName=By.xpath("//td[text()='KUKKA-123']");
