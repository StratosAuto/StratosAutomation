...
public class Stratos_Manager_Dashboard_Pageobjects {
	...
	public static final By activeEmployees=By.xpath("//app-employee-shfits[@class='ng-star-inserted']/div/div/div/div/li");
	public static final By validateEmployeeName=By.xpath("(//app-employee-shfits[@class='ng-star-inserted']/div/div/div/div/div/div/div/p)[2]");
	public static final By validateSupervisorName=By.xpath("(//app-employee-shfits[@class='ng-star-inserted']/div/div/div/div/div/div/div/p)[5]");
	public static final By validateTask=By.xpath("(//div[@class='row'])[3]/div");
	public static final By validateTaskDescription=By.xpath("(//div[@class='row'])[3]/div[2]");
